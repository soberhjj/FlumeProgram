package com.newland.suyuan.interceptor;
...
/**
 * @Author: huangJunJie  2020-12-23 15:07
 */
public class SuyuanInterceptor implements Interceptor {
    private static final Logger logger = LoggerFactory.getLogger(SuyuanInterceptor.class);
    ...
    public static class Builder implements Interceptor.Builder {
        ...
        public Interceptor build() {
            return new SuyuanInterceptor();
        }
    }

    /**
     * 返回的是List<Object>，该List中包含三个元素。
     ...
     */
    private static final String SeparatorA = "\001";
    private static final String SeparatorB = "\002";
    private static final String SeparatorC = "\003";
